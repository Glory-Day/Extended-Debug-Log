...
namespace GloryDay.Debug
{
    public static class Debugger
    {
        ...
        /// </summary>
        /// <param name="type"> <see cref="LogType"/> to distinguish between types of logs </param>
        /// <param name="message"> Additional explanation of progress </param>
        /// <param name="className"> Name of class to which the log is called </param>
        /// <param name="methodName"> Name of method to which the log is called </param>
        private static string Build(LogType type, string message, string className, string methodName)
        {
            string log;

            switch (type)
            {
                case LogType.Administrator:
        ...
        public static void LogAsAdministrator(string message, [CallerMemberName] string methodName = "", [CallerFilePath] string filePath = "")
        {
            ...
            UnityEngine.Debug.LogWarning(Build(LogType.Administrator, message, className, methodName));

#elif DEVELOPMENT_BUILD

            using (var writer = new StreamWriter(UnityEngine.Application.persistentDataPath + LogFileName, true))
            {
                writer.WriteLine(Build(LogType.Administrator, message, className, methodName));
            }
        ...
        public static void LogMessage(string message, [CallerMemberName] string methodName = "", [CallerFilePath] string filePath = "")
        {
            ...
            UnityEngine.Debug.Log(Build(LogType.Message, message, className, methodName));

#elif DEVELOPMENT_BUILD

            using (var writer = new StreamWriter(UnityEngine.Application.persistentDataPath + LogFileName, true))
            {
                writer.WriteLine(Build(LogType.Message, message, className, methodName));
            }
        ...
        public static void LogError(string message, [CallerMemberName] string methodName = "", [CallerFilePath] string filePath = "")
        {
            ...
            UnityEngine.Debug.LogError(Build(LogType.Error, message, className, methodName));

#elif DEVELOPMENT_BUILD

            using (var writer = new StreamWriter(UnityEngine.Application.persistentDataPath + LogFileName, true))
            {
                writer.WriteLine(Build(LogType.Error, message, className, methodName));
            }
        ...
        public static void LogSuccess(string message, [CallerMemberName] string methodName = "", [CallerFilePath] string filePath = "")
        {
            ...
            UnityEngine.Debug.Log(Build(LogType.Success, message, className, methodName));

#elif DEVELOPMENT_BUILD

            using (var writer = new StreamWriter(UnityEngine.Application.persistentDataPath + LogFileName, true))
            {
                writer.WriteLine(Build(LogType.Success, message, className, methodName));
            }
